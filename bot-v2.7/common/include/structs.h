...
enum Evaluations { DRAW_SCORE = 0, MATE_SCORE = 30000, MATE_IN_100_SCORE = 29900, NEGATIVE_INFINITY = -1000000, POSSITIVE_INFINITY = 1000000 };
...
struct Evalboards {
    int PieceValues[7];
    int game_stage_values[7];
    int Knightboard[8][8];
    int Bishopboard[8][8];
    int Pawnboard[8][8];
    int Rookboard[8][8];
    int QueenEarlyboard[8][8];
    int QueenLateboard[8][8];
    int KingEarlyboard[8][8];
    int KingLateboard[8][8];
};
